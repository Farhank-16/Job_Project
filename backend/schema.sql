-- Rural Job Platform Database Schema
...
-- Contact Requests Table (for tracking employer-seeker contacts)
...
INSERT INTO users (mobile, name, role, is_verified, profile_completed) 
VALUES ('9999999999', 'System Admin', 'admin', TRUE, TRUE);

-- Update existing admin's mobile (replace 1 with actual admin ID if needed) (Run in sql)
/*UPDATE users 
SET mobile = '9876543210' 
WHERE role = 'admin' AND mobile = '9999999999';
*/


-- Insert multiple admins at once (if needed) using sql
/*INSERT INTO users (mobile, name, role, is_verified, profile_completed) VALUES
('9876543210', 'System Admin', 'admin', TRUE, TRUE),
('9876543211', 'Super Admin', 'admin', TRUE, TRUE),
('9876543212', 'Platform Admin', 'admin', TRUE, TRUE),
('9876543213', 'Main Admin', 'admin', TRUE, TRUE);
*/